...
XS_EXTERNAL(boot_Verilog__Parser)
{
    ...
    XS_VERSION_BOOTCHECK;
        ...
        (void)newXSproto_portable((char*)"Verilog::Parser::_new", XS_Verilog__Parser__new, file, (char*)"$$$$");
        (void)newXSproto_portable((char*)"Verilog::Parser::_DESTROY", XS_Verilog__Parser__DESTROY, file, (char*)"$");
        (void)newXSproto_portable((char*)"Verilog::Parser::_debug", XS_Verilog__Parser__debug, file, (char*)"$$");
        (void)newXSproto_portable((char*)"Verilog::Parser::_callback_master_enable", XS_Verilog__Parser__callback_master_enable, file, (char*)"$$");
        (void)newXSproto_portable((char*)"Verilog::Parser::_use_cb", XS_Verilog__Parser__use_cb, file, (char*)"$$$");
        (void)newXSproto_portable((char*)"Verilog::Parser::eof", XS_Verilog__Parser_eof, file, (char*)"$");
        (void)newXSproto_portable((char*)"Verilog::Parser::filename", XS_Verilog__Parser_filename, file, (char*)"$;$");
        (void)newXSproto_portable((char*)"Verilog::Parser::language", XS_Verilog__Parser_language, file, (char*)"$$");
        (void)newXSproto_portable((char*)"Verilog::Parser::lineno", XS_Verilog__Parser_lineno, file, (char*)"$;$");
        (void)newXSproto_portable((char*)"Verilog::Parser::parse", XS_Verilog__Parser_parse, file, (char*)"$$");
        (void)newXSproto_portable((char*)"Verilog::Parser::selftest", XS_Verilog__Parser_selftest, file, (char*)"$");
        (void)newXSproto_portable((char*)"Verilog::Parser::unreadback", XS_Verilog__Parser_unreadback, file, (char*)"$;$");
        (void)newXSproto_portable((char*)"Verilog::Parser::unreadbackCat", XS_Verilog__Parser_unreadbackCat, file, (char*)"$$");
#if (PERL_REVISION == 5 && PERL_VERSION >= 9)
  if (PL_unitcheckav)
