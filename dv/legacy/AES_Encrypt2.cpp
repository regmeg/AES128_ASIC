...
//#####################################################################
// For verilog DPI function

void set_key_and_block_data(unsigned char Key_in[32], unsigned char in_block[32])
{
	int i,j;
	// Calculate Nk and Nr from the recieved value.
	Nr = 128; // Set 128 bit key to be as default
	Nk = Nr / 32;
	Nr = Nk + 6;
...
extern unsigned char* return_data()
{
	int i,j;
